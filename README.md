...
**Goal:** Provide a simple Bash script that displays basic information about a Linux server’s performance. More details: https://roadmap.sh/projects/server-stats.

**Users:** Linux server administrators.
...
> Note: The script must be able to run on any Linux server.
...
> This is a [roadmap.sh](https://roadmap.sh) project. No license is provided.
